...
export class CircleCiClient {
    ...
    public async listSuccessfulWorkflowRecentRuns(versionControlSlug: string, organization: string, repository: string, workflowName: string): Promise<ListWorkflowRecentRunsResponse> {

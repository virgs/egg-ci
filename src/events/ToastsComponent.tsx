...
export const ToastsComponent = (): JSX.Element => {
    ...
    useNewNotificationListener(payload => {
        ...
        const newToast = <div className="toast" key={key} id={key} role="alert" aria-live="assertive" aria-atomic="true">
    ...
    const removeToast = (toast: ToastData) => {
        setToasts(toasts => toasts.map(item => {
    ...
    return <div aria-live="polite" aria-atomic="true" className="position-relative">
        {/* <!-- Position it: -->

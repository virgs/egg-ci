...
26. [ ] Add a button in the dashboard page to switch the jobs between grid and list view. 
...
27. ~[ ] Be able to merge workflow data (autosync pipelines)~
28. ~[ ] Card placeholders~
